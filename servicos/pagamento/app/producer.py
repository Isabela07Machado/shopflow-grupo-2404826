"""
Esqueleto do produtor de eventos do serviço de Pagamento.

No Módulo 3 este módulo publicará eventos como pagamento.aprovado
e pagamento.recusado na exchange pagamento.eventos.
"""
...
def declarar_exchange(channel: pika.channel.Channel) -> None:
    """Declara a exchange de eventos do serviço de pagamento."""
