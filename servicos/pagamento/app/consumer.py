"""
Esqueleto do consumidor de eventos do serviço de Pagamento.

No Módulo 3 este módulo escutará eventos como pedido.aprovado_fraude
para iniciar o processamento de cobrança.
"""
